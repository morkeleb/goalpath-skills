...
- Statuses: **Concept** (idea stage), **Planned** (defined, ready to work), **InProgress**, **Done**
...
Use `WebSearch` and `WebFetch` to research the idea externally. If these tools are unavailable, skip web research and note in the PRD that external validation was not performed. When available, research should cover:
